...
def figbar(floatnowval):
    ...
    print(f'strnowval {strnowval}')
    strnowval = strnowval.replace("₩","")
    floatnowval2 = float(strnowval)
    print(f'figbar floatnowval2 = {floatnowval2}')
    ...
    ys = np.array([floatnowval2,floatnowval2,floatnowval2,floatnowval2,floatnowval2,floatnowval2,floatnowval2,floatnowval2,floatnowval2,floatnowval2])
    y2 = np.array([108,108,108,108,108,108,108,108,108,108])
    y3 = np.array([106,106,106,106,106,106,106,106,106,106])
