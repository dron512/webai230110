...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_CLASS"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_RUN_IMAGE
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_RUN_IMAGE"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_TERM
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_TERM"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_TERM_CODES
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_TERM_CODES"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Table ABC
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into PGH_CLASS (CLS_NUM,CLS_NAME,CLS_SRC_PATH,SUB_NUM,CLS_DATE,RUN_NUM) values (104,'제목','D:\work\csharp\project\10\project\project\project\Lib\Windows\Frame\MasterPop.cs',null,to_date('23/05/09','RR/MM/DD'),1);
