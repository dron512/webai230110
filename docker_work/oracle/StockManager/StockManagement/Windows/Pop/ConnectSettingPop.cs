...
namespace StockManagement.Windows.Pop
{
    public partial class ConnectSettingPop : Form
    {
        ...
        private void ReadDBInformation() {
            m_addr = m_IniManager.ReadString("db", "addr", "ec2-3-38-253-162.ap-northeast-2.compute.amazonaws.com");
            m_database = m_IniManager.ReadString("db", "database", "xe");
            m_id = m_IniManager.ReadString("db", "id", "system");
            m_pwd = m_IniManager.ReadString("db", "pwd", "oracle");
