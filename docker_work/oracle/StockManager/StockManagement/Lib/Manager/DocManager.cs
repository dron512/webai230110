...
namespace Lib.Manager
{
    ...
    class DocManager
    {
        ...
        {
            m_DBInfo._Addr = m_IniManager.ReadString("db", "addr", "ec2-3-38-253-162.ap-northeast-2.compute.amazonaws.com");
            m_DBInfo._Port = m_IniManager.ReadInteger("db", "port", 1521);
            m_DBInfo._Id = m_IniManager.ReadString("db", "id", "system");
            m_DBInfo._Pwd = m_IniManager.ReadString("db", "pwd", "oracle");
