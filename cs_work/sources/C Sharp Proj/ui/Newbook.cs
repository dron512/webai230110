...
{
    partial class Newbook : UserControl
    {
        DaoOra ora = null;
        ...
        MainForm mf;
        public Newbook(DaoOra ora, string genre, MainForm mf)
        {
            InitializeComponent();
            this.ora = ora;
            this.mf = mf;
            ...
            show_new(selected_genre, 0);
        }
        public Newbook(DaoOra ora, string genre, MainForm mf, int page)
        {
            InitializeComponent();
            this.ora = ora;
            this.mf = mf;
        ...
        private void show_new(string genre, int page)
        {
            makeInvisible();
            OracleDataReader dr = ora.selectNew(genre, page);
            if (dr.HasRows)
            {
                ...
                int bookCount = ora.getNewCount(genre);
                pages = bookCount / 6;
                try
                {
        ...
        private void nextPage_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(page.Text) < max)
            {
                ...
                show_new(selected_genre, int.Parse(page.Text) - 1);
            }
        }
        ...
        private void title1_Click(object sender, EventArgs e)
        {
            if (title1.Text != "")
            {
                mf.controlView(new Bookinfo(ora, pic1.Image, rank1.Text, title1.Text, author1.Text, pub1.Text, date1.Text, price1.Text, sales1.Text, selected_genre, page.Text, mf, 3), UC_BOOKINFO);
            }
        }
        ...
        private void title2_Click(object sender, EventArgs e)
        {
            if (title2.Text != "")
            {
                mf.controlView(new Bookinfo(ora, pic2.Image, rank2.Text, title2.Text, author2.Text, pub2.Text, date2.Text, price2.Text, sales2.Text, selected_genre, page.Text, mf, 3), UC_BOOKINFO);
            }
        }
        ...
        private void title3_Click(object sender, EventArgs e)
        {
            if (title3.Text != "")
            {
                mf.controlView(new Bookinfo(ora, pic3.Image, rank3.Text, title3.Text, author3.Text, pub3.Text, date3.Text, price3.Text, sales3.Text, selected_genre, page.Text, mf, 3), UC_BOOKINFO);
            }
        }
        ...
        private void title4_Click(object sender, EventArgs e)
        {
            if (title4.Text != "")
            {
                mf.controlView(new Bookinfo(ora, pic4.Image, rank4.Text, title4.Text, author4.Text, pub4.Text, date4.Text, price4.Text, sales4.Text, selected_genre, page.Text, mf, 3), UC_BOOKINFO);
            }
        }
        ...
        private void title5_Click(object sender, EventArgs e)
        {
            if (title5.Text != "")
            {
                mf.controlView(new Bookinfo(ora, pic5.Image, rank5.Text, title5.Text, author5.Text, pub5.Text, date5.Text, price5.Text, sales5.Text, selected_genre, page.Text, mf, 3), UC_BOOKINFO);
            }
        }
        ...
        private void title6_Click(object sender, EventArgs e)
        {
            if (title6.Text != "")
            {
                mf.controlView(new Bookinfo(ora, pic6.Image, rank6.Text, title6.Text, author6.Text, pub6.Text, date6.Text, price6.Text, sales6.Text, selected_genre, page.Text, mf, 3), UC_BOOKINFO);
            }
        }
        private void bestBtn_Click(object sender, EventArgs e)
        {
            mf.controlView(new Newbook(ora, "all", mf), UC_NEWBOOK);
        }
        private void novelBtn_Click(object sender, EventArgs e)
        {
            mf.controlView(new Newbook(ora, "novel", mf), UC_NEWBOOK);
        }
        private void inmunBtn_Click(object sender, EventArgs e)
        {
            mf.controlView(new Newbook(ora, "inmun", mf), UC_NEWBOOK);
        }
        private void devBtn_Click(object sender, EventArgs e)
        {
            mf.controlView(new Newbook(ora, "dev", mf), UC_NEWBOOK);
        }
        private void financeBtn_Click(object sender, EventArgs e)
        {
            mf.controlView(new Newbook(ora, "finance", mf), UC_NEWBOOK);
        }
        private void comicsBtn_Click(object sender, EventArgs e)
        {
            mf.controlView(new Newbook(ora, "comics", mf), UC_NEWBOOK);
        }
